...
export const isAdmin = async (req, res, next) => {
  try {
    ...
    res
      ...
      .send({
        success: false,
        message: "You are not an Admin , UnAuthorized Access...!",
        error,
      });
  }
};
  ...
  try {
    ...
    if (user.role !== 2) {
      return res
        ...
        .send({
          success: false,
          message: "UnAuthorized Access You Are not  Super Admin..!",
        });
    } else {
      next();
    }
    ...
    res
      ...
      .send({
        success: false,
        message: "You are not an Super Admin , UnAuthorized Access...!",
        error,
      });
  }
};
  ...
  try {
    ...
    if (user.role !== 0 || user.admin.status !== "Active") {
      return res
        ...
        .send({
          success: false,
          message: "UnAuthorized Access U r not the Admin...!",
        });
    } else {
      next();
    }
    ...
    res
      ...
      .send({
        success: false,
        message: "You r not an Staff , UnAuthorized Access...!",
        error,
      });
  }
};
