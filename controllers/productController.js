...
// export const createProdudfctController = async (req, res) => {
//   try {
//     const {
//       itemCode,
//       productName,
...
//     const photoFiles = req.files ? Object.values(req.files) : [];
...
//     // Assuming `products` is a model instance, e.g., from Mongoose
...
export const createProductController = async (req, res) => {
  try {
    ...
    console.log(req.fields, "Form Data Fields");
