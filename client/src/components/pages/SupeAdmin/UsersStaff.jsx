...
//     setStaffList([]); // Clear previous staffDetails to avoid showing stale data
...
//       } else {
//         setStaffList([]); // Ensure staffDetails is an empty array if no staff found
//       }
//     } catch (err) {
//       console.error('Failed to fetch staff details:', err);
//       setStaffList([]); // Ensure state updates even in case of error
//     }
//   };
...
//       {/* Rendering staff details if available */}
//       {selectedUser && staffList.length > 0 && (
//         <Paper sx={{ marginTop: 2, padding: 2 }}>
//           <Typography variant="h6">{selectedUser.userName}'s Staff</Typography>
//           <TableContainer>
//             <Table>
//               <TableHead>
//                 <TableRow>
