  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post(
        "/api/v1/deliveryChallanRoute/createDeliveryChallan",
        data
      );
      if (response) {
          ...
          <form className="print">
            ...
            <div className="p-4 border-b border-gray-300 bg-gray-100">
              <div className="grid grid-cols-1 sm:grid-cols-4 md:grid-cols-4 lg:grid-cols-4  gap-4">
                ...
                <div>
                  <label className="block font-bold">Challan No</label>
                  <input
                    type="text"
                    name="ChallanNo"
                    className="border p-2 rounded w-full"
                ...
                <div>
                  ...
                  <input
                    ...
                    name="selectCustomer"
                    className="border p-2 rounded w-full"
                    value={quotation.selectCustomer}
                    onChange={handleInputChange}
                  />
                </div>
                <div>
            ...
            <div className="p-4 bg-gray-100 mt-4 overflow-x-auto">
              ...
              <table className="w-full border ">
                ...
                <tbody>
                  {quotation.rows.map((product, index) => (
                    <tr key={product.id}>
                ...
                <div className="flex gap-5 text-right ">
                  ...
                  <div>
                    <span className="block mb-4 font-bold">
                      Rs. {quotation.taxAmount.toFixed(2)}
                    </span>
