...
{selectedPayIn && (
  ...
  >
    ...
    <div className="grid grid-cols-2 gap-4 mt-4">
      ...
      <div className="flex flex-col">
        <label className="text-md font-bold text-black">Customer Name</label>
        <input
          type="text"
      ...
      {receiptMode === "Bank" && (
        <>
          <div className="flex flex-col">
            <label className="text-md font-bold text-black">Select Bank</label>
            <select
              value={selectBank}
              onChange={(e) => {
          ...
          <div className="flex flex-col">
            <label className="text-md font-bold text-black">Transaction / Cheque No</label>
            <input
              type="text"
              ...
              <tr key={index}>
                ...
                <td className="px-4 py-2 border text-black">
                  <input
                    type="text"
                    value={row.billNo}
                    onChange={(e) => handleBillRowChange(index, "billNo", e.target.value)}
                ...
                <td className="px-4 py-2 border text-black">
                  <input
                    ...
                    onChange={(e) => handleBillRowChange(index, "billAmount", e.target.value)}
                    className="p-1 w-full border border-gray-500 rounded-md"
                  />
                </td>
                <td className="px-4 py-2 border text-black">
                  <input
                    ...
                    onChange={(e) => handleBillRowChange(index, "receivedAmount", e.target.value)}
                    className="p-1 w-full border border-gray-500 rounded-md"
                  />
                </td>
                <td className="px-4 py-2 border text-black">
                  <input
                    ...
                    onChange={(e) => handleBillRowChange(index, "balanceAmount", e.target.value)}
                    className="p-1 w-full border border-gray-500 rounded-md"
                  />
                </td>
                <td className="px-4 py-2 border text-black">
