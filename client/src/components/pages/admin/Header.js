            ...
            {isMenuOpen && (
               ...
               <div className="dropdown-trigger text-nowrap absolute mt-2 p-2 right-0 bg-slate-200 text-stone-950 rounded shadow">
                <select className="dropdown-trigger text-nowrap relative p-2 right-0 bg-slate-200 text-stone-950 rounded border-none">
                  ...
                  <option>
                  <Link to="#option1" className="dropdown-trigger text-nowrap w-full p-3 right-0 bg-slate-200 text-stone-950 rounded shadow">Create Company </Link>
                  </option>
                  <option>
                  <Link to="#option2" className="dropdown-trigger text-nowrap w-full p-3 right-0 bg-slate-200 text-stone-950 rounded shadow">Alter Company</Link>
                  </option>  <option>
                  <Link to="#option3" className="dropdown-trigger text-nowrap w-full  p-3 right-0 bg-slate-200 text-stone-950 rounded shadow">List Of Company</Link>
                  </option>
                </select>
               </div>
             </div>
