  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="flex flex-col">
          <label className="text-md font-bold text-black">Customer Detail</label>
          <input
            type="text"
            name="customerDetail"
            ...
            {invoice.rows.map((row, index) => (
              <tr key={index}>
                ...
                <td className="border">
                  <Select
                    id="itemcode-select"
                    value={{ label: row.itemCode, value: row.itemCode }}
                ...
                <td className="border">
                  <Select
                    id="product-select"
                    value={{ label: row.productName, value: row.productName }}
                    onChange={(selectedOption) => handleRowChange(index, 'productName', selectedOption.value)}
                    options={[
                      { label: "Product A fsf fdf", value: "Product A fsf fdf" },
                ...
                <td className="border p-1">
                  <input
                    ...
                    onChange={(e) => handleRowChange(index, "retailPrice", e.target.value)}
                    className="w-full"
                  />
                </td>
                <td className="border p-1">
      ...
      <div className="flex flex-col items-end gap-5 mt-10">
        <div className="flex flex-row justify-left gap-3">
          <label className="text-1xl font-bold text-black mt-2">Gross Amount</label>
          <input
            type="text"
        ...
        <div className="flex flex-row justify-left gap-3">
          <label className="text-1xl font-bold text-black mt-2">GST Amount</label>
          <input
            type="text"
        ...
        <div className="flex flex-row justify-left gap-3">
          <label className="text-1xl font-bold text-black mt-2">Net Amount</label>
          <input
            type="text"
