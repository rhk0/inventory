  ...
  return (
    <div className="grid-container">
      ...
      <Routes>
        ...
        {/* rahul routing */}
        <Route
          path="/updateCompanyRegistration"
          element={<UpdateCompanyRegistration />}
        />
        <Route
          path="/orderPurchaseInvoice/:_id"
          element={<OrderPurchaseInvoice />}
        />
        <Route
          path="/EstimateSalesInvoice/:_id"
          element={<EstimateSalesInvoice />}
        />
        ...
        <Route
          path="ManufacturerWisereport"
          element={<ManufactureWiseReport />}
        />
