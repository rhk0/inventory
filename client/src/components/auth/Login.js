...
const Login = () => {
  return (
    <div className="bg-gradient-to-br from-blue-500 to-yellow-500 h-screen flex justify-center items-center text-white font-montserrat">
      <div className="login-card p-8 w-full max-w-md flex flex-col">
        ...
        <div className="form">
          <div className="form-field username relative mb-6">
            ...
            <input
              ...
              className="pl-12 pr-4 py-2 w-full bg-opacity-10 border border-white rounded-lg focus:bg-white focus:text-red-600 focus:outline-none transition duration-300"
            />
          </div>
          ...
          <button
            type="submit"
            className="bg-white text-red-600 py-3 px-4 w-full rounded-full uppercase font-bold mb-8 focus:outline-none transition duration-300 hover:bg-red-600 hover:text-white"
          >
            Login
          </button>
          ...
          <div className="text-white text-center">
            <Link href="#" className="text-white font-bold hover:text-yellow-400">
              Forgot password?
            </Link>
          </div>
        </div>
